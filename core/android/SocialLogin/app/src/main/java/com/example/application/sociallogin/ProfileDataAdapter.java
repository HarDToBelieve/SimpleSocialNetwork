...
public class ProfileDataAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    List<ProfileData> newfeedData;
    Context context;
    ...
    public ProfileDataAdapter(RecyclerView recyclerView, List<ProfileData> newfeedData, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if(viewType == VIEW_TYPE_ITEM) {
            ...
            View itemView = layoutInflater.inflate(R.layout.activity_profile_item, parent, false);
            return new StatusViewHolder(itemView);
        } else {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_profile_loading, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof StatusViewHolder) {
            final ProfileData listItem = newfeedData.get(position);
