...
//            String likerUrl = "http://161.202.20.61:5000/likepost?postID=" + listItem.getPostID();
...
//                                JSONArray arrayLike = jsonObject.getJSONArray("Likes");
//                                if(arrayLike.length() > 0) {
//                                    for (int i = 0; i < arrayLike.length(); i++) {
//                                        Log.d("PostID", listItem.getPostID() + ' ' + arrayLike.getString(i));
//                                        if (name.equals(arrayLike.getString(i))) {
//                                            isLiked = true;
//                                            break;
//                                        } else {
//                                            isLiked = false;
...
//                                }
//                                if(isLiked) {
//                                    statusViewHolder.like.setText("UNLIKE");
//                                }
//
//                                statusViewHolder.like.setOnClickListener(
//                                        new View.OnClickListener() {
//                                            @Override
//                                            public void onClick(View view) {
//                                                if (!isLiked) {
//                                                    String likeActionUrl = "http://161.202.20.61:5000/likepost";
//                                                    StringRequest stringRequest = new StringRequest(Request.Method.GET,
//                                                            likeActionUrl,
//                                                            new Response.Listener<String>() {
//                                                                @Override
